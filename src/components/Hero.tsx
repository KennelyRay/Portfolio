  ...
  return (
    <div className="flex min-h-[calc(100vh-8rem)] flex-col justify-between">
      ...
      <motion.a
        ...
        className="mx-auto mt-10 inline-flex flex-col items-center gap-1 text-center text-gray-500 transition-colors duration-300 hover:text-[var(--color-brand-blue)]"
        aria-label="Scroll down to about section"
      >
        <span className="text-[10px] font-bold uppercase tracking-[0.35em]">
          Scroll
        </span>
        <span className="text-4xl font-light leading-none">V</span>
      </motion.a>
    </div>
  );
}
